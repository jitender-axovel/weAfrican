...
class BannersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('banners.index', compact('pageTitle', 'homeBanners', 'eventBanners', 'businessBanners'));
    }
    ...
    public function blockBusinessBanner($id)
    {
        ...
        if ($banner->is_blocked) {
            return redirect('banners')->with('success', 'Business Banner blocked successfully');
        } else {
            return redirect('banners')->with('success', 'Business Banner unblocked successfully');
        }
    }
